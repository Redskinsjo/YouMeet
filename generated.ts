...
export type CreateInterestedIndividualAndSendEmailMutation = { __typename?: 'Mutation', createInterested?: { __typename?: 'InterestedIndividual', email?: string | null } | null };
...
export type InterestedIndividualResolvers<ContextType = any, ParentType extends ResolversParentTypes['InterestedIndividual'] = ResolversParentTypes['InterestedIndividual']> = {
  email?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  createInterested?: Resolver<Maybe<ResolversTypes['InterestedIndividual']>, ParentType, ContextType, Partial<MutationCreateInterestedArgs>>;
...
export const CreateInterestedIndividualAndSendEmailDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateInterestedIndividualAndSendEmail"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"email"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createInterested"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"email"},"value":{"kind":"Variable","name":{"kind":"Name","value":"email"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"email"}}]}}]}}]} as unknown as DocumentNode<CreateInterestedIndividualAndSendEmailMutation, CreateInterestedIndividualAndSendEmailMutationVariables>;
